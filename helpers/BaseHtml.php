...
class BaseHtml
{
     ...
     * @since 2.0.4
     */
    public static function activeHint($model, $attribute, $options = array())
    {
        $attribute = static::getAttributeName($attribute);
    ...
    public static function activeFileInput($model, $attribute, $options = array())
    {
        ...
        $hiddenOptions = array('id' => null, 'value' => '');
     ...
     * @since 2.0.9
     */
    protected static function activeBooleanInput($type, $model, $attribute, $options = array())
    {
        $name = isset($options['name']) ? $options['name'] : static::getInputName($model, $attribute);
        $value = static::getAttributeValue($model, $attribute);
     ...
     */
    protected static function activeListInput($type, $model, $attribute, $items, $options = array())
    {
        $name = isset($options['name']) ? $options['name'] : static::getInputName($model, $attribute);
